              ...
              <h4 className="font-semibold lg:leading-normal leading-normal tracking-wide text-4xl mb-5">
                ...
                <span className="text-teal-500 font-bold textMove">
                  <div className="text-container">
                    <span className="mb-2" style={{ "--i": 0 }}>
                      Ecommerce
                      <br />
                    </span>
                    <span className="mb-2" style={{ "--i": 1 }}>
                      Fintech
                      <br />
                    </span>
                    <span className="mb-2" style={{ "--i": 2 }}>
                      Healthcare
                      <br />
                    </span>
                    <span className="mb-2" style={{ "--i": 3 }}>
                      Travel &amp; Hospitality
                      <br />
                    </span>
                    <span className="mb-2" style={{ "--i": 4 }}>
                      Real Estate
                      <br />
                    </span>
                  </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                ...
                <div className="absolute top-16 md:-end-10 -end-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-48 m-3">
                  <h5 className="text-lg font-semibold mb-3 ml-3">
                    Strategic Partner
                  </h5>
